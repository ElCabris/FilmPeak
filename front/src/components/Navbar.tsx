...
const storedProfileAvatar = sessionStorage.getItem('selectedProfileAvatar');

const profileName = storedProfileName && storedProfileName !== "null" ? storedProfileName : 'Perfil';
const profileAvatar = storedProfileAvatar && storedProfileAvatar !== "null" ? storedProfileAvatar : null;
...
return (
  <nav className="fixed top-0 w-full left-0 bg-gradient-to-b from-black/90 via-black/80 to-black/50 z-50 px-2 py-3">
    <div className="max-w-7xl mx-auto flex items-center justify-between">
      ...
      {/* Dropdown perfil con avatar o inicial */}
      <div className="relative" ref={dropdownRef}>
        <div
          className="w-10 h-10 rounded-full overflow-hidden border border-gray-600 flex items-center justify-center bg-gray-700 text-white text-sm font-semibold hover:border-white transition-all cursor-pointer"
